...
define('app',['exports', 'aurelia-framework', 'BLAdapter'], function (exports, _aureliaFramework, _BLAdapter) {
  ...
  var App = exports.App = (_dec = (0, _aureliaFramework.inject)(_BLAdapter.BLAdapter), _dec(_class = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      config.title = 'Au PWA';
      config.map([{ route: ['', 'search'], name: 'search', moduleId: 'search/search', nav: false, title: 'Search' }, { route: 'settings', name: 'settings', moduleId: 'settings/settings', nav: false, title: 'settings' }]);
...
define('search/ehr',["exports"], function (exports) {
  "use strict";
  ...
  var EHR = exports.EHR = function EHR() {
...
define('search/search',['exports'], function (exports) {
  'use strict';
...
define('settings/settings',['exports', 'aurelia-framework', 'BLAdapter', 'aurelia-router'], function (exports, _aureliaFramework, _BLAdapter, _aureliaRouter) {
    'use strict';
    ...
    var Settings = exports.Settings = (_dec = (0, _aureliaFramework.inject)(_BLAdapter.BLAdapter, _aureliaRouter.router), _dec(_class = function () {
        function Settings(blAdapter, router) {
